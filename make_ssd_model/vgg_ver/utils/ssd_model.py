...
#     conv7 = nn.Conv2d(1024, 1024, kernel_size=1)
    ...
    Maxpool_5, Conv2_14, nn.ReLU(inplace=True), Conv2_15, nn.ReLU(inplace=True)]
...
#         print(num_classes)
        ...
        conf_t_label = torch.zeros((num_batch, num_dbox), dtype=torch.long).to(self.device)
        loc_t = torch.zeros((num_batch, num_dbox, 4), dtype=torch.float32).to(self.device)
